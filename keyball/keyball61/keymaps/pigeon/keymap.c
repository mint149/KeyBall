...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WINDOWS] = LAYOUT_universal(
    ...
    DELETED, DELETED, DM_PLY1, KC_LGUI, KC_LALT, IMEOFF , KC_SPC , KC_RGUI, IMEON  , NOSPACE, NOSPACE, NOSPACE, KC_PSCR, DELETED
  ),
  ...
  [_MAC] = LAYOUT_universal(
    ...
    KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , _______, _______, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_QUOT,
    DELETED, DELETED, DM_PLY1, KC_LALT, KC_LGUI, IMEOFF , KC_SPC , KC_LCTL, IMEON  , NOSPACE, NOSPACE, NOSPACE, SCRLTRG, DELETED
  ),
